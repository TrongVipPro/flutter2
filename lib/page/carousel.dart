...
class _MyCarouselState extends State<MyCarousel> {
  ...
  void initState() {
    super.initState();
    lstProduct = createDataList(10); // Sửa lại để gán giá trị cho lstProduct
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("My Carousel: Truong Trong"), // Sửa dấu " thành "
      ),
      body: Container(
        padding: const EdgeInsets.all(16),
        alignment: Alignment.center,
        child: slide(lstProduct)), // Thay thế lstProduct bằng IsProduct
      );
  }
